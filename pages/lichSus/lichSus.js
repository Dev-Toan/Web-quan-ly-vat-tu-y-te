$(document).ready(function () {
  ...
  var vatTusTable = $("#vatTusTable").DataTable({
    ajax: {
      url: "http://localhost:3000/lichSus?_expand=nhanSu",
      dataType: "json",
      dataSrc: "",
    },
    columns: [
...
//xuat excel
$('#btnExportExcelLichSu').on('click',function(){
  ...
  var exportData= [
      ["Tiêu đề","Người thực hiện","Nội dung","Thời gian"]// tiêu đề cột
  ];
  ...
  //xuat file
  XLSX.writeFile(workbook, "LichSuHoatDong.xlsx");
});
});
